...
========================================================================================
Deploys the Sovereign Civilization & Cellular Automata interactive Space to Hugging Face.

Usage:
    python deploy_to_hf.py --repo_id <username>/<space_name> --token <hf_token>
Or with environment variable:
    set HF_TOKEN=your_huggingface_token
    python deploy_to_hf.py --repo_id <username>/<space_name>
========================================================================================
"""
...
def deploy(repo_id: str, token: str = None):
    ...
    print(f"Creating / connecting to Hugging Face Space: {repo_id}...")
    create_repo(
        repo_id=repo_id,
        repo_type="space",
        space_sdk="gradio",
    ...
    print(f"Uploading files from {space_dir} to Space {repo_id}...")
    
    api.upload_folder(
        folder_path=space_dir,
        repo_id=repo_id,
        repo_type="space",
        ignore_patterns=["__pycache__/*", "*.pyc", "test_hf_app.py", "deploy_to_hf.py"]
    )
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Deploy Sovereign Civilization to Hugging Face Spaces")
